...
Below, we give an explicit example of an IFS that satisfies the SESC. A lengthy calculation
(omitted) shows that measures in a small neighbourhood
of the natural measure exhibit a dimension drop of the $L^q$ dimension for large $q$.
