...
%{\color{red}Is this not just Hausdorff? See\cite[Corollay 1.4]{Rapaport_SelfConfESC25arXiv}}.
...
%{\color{red} Should we also mention conjugation to self-sim? or that doesn't fit with the narrative here}
...
$$
d_2((f_i)_{i=1}^N,(g_i)_{i=1}^N)\coloneqq\max_{i,j\in\mathcal{I}}d_2(f_i,g_j)
$$
...
%We define the cylinder sets {\color{red} Are they actually used anywhere? Doesn't seem so..}
...
%{\color{red} Is there anything to say about self-conformal measures? Otherwise it feels a bit like just hanging out there but not going anywhere}
...
By \cref{thm:DualSSC}, it is enough to show that the set $\{\Phi\in\mathfrak{S}_N:\Phi^*\text{
