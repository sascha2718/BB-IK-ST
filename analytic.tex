...
IFS of linear fractional transformations with such a common fixed point structure for which the
dimension of the attractor does not drop. However, he studied the system via sufficiently large
subsystems, and it was not verified that the IFS itself satisfies the ESC.
