...
values of $\eta_i$ possibly {\color{red}larger?}, one can ensure that
...
\begin{align*}
	I(x)&\leq {\color{red}\varepsilon+ } \delta \cdot \frac{|f'(y_i)|}{|f(y_i)|} \prod_{\substack{y_j\in\mathcal{Y} \\
	y_j\neq y_i}} \frac{(x-y_j)^2}{(y_i - y_j)^2}  \prod_{z_j\in\mathcal{Z}}
	\frac{(x-z_j)^4}{(y_i - z_j)^4} \\
	&\stackrel{\eqref{eq:eta1/3Bound}}{\leq}  {\color{red}\varepsilon+ } \delta \cdot
